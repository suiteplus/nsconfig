...
module.exports = function (params, nothrow) {
...
var PARAMS_DEF = [{ name: 'email', required: true }, { name: 'password', required: true }, { name: 'account', required: true }, { name: 'realm', def: 'system.netsuite.com' }, { name: 'role' }, { name: 'rootPath', def: '/SuiteScripts' }, { name: 'script', required: true }, { name: 'deployment', def: 1 }]; //ps: default is reserved word
...
function checkParams(params, nothrow) {
    var out = PARAMS_DEF.reduce(function (prev, curr) {
